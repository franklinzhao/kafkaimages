...
docker export kafka1 > broker1_Image.tar | gzip > broker1.tar.gz
docker export kafka2 > broker2_Image.tar | gzip > broker2.tar.gz
docker export kafka3 > broker3_Image.tar | gzip > broker3.tar.gz
docker export zoo1 > zookeeperImage.tar | gzip > zooKeeper.tar.gz
Then load the exported image to Docker using the below command:

gunzip zooKeeperImage.tar.gz
docker import zooKeeperImage.tar
